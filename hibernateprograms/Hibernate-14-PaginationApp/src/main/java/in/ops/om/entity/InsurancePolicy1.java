...
@Entity
@NamedQuery(name = "GET_POLICIES_COUNT", query="SELECT count(*) FROM in.ops.om.entity.InsurancePolicy1 ")
@NamedQuery(name = "GET_ALL_POLICIES", query="FROM in.ops.om.entity.InsurancePolicy1 ")

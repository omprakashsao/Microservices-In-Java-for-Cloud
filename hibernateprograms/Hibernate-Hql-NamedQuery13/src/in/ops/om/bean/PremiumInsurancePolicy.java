...
@Entity
@NamedQuery(name = "HQL_TRANSFER_POLICIES", query = "INSERT INTO in.ops.om.bean.PremiumInsurancePolicy(policyId,policyName, policyType, policyTime, tenure) SELECT i.policyId, i.policyName, i.policyType, i.policyTime, i.tenure FROM in.ops.om.bean.InsurancePolicy AS i WHERE i.tenure >=: min")
